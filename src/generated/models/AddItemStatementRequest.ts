...
import type { AddItemStatementRequestAllOfStatement } from './AddItemStatementRequestAllOfStatement';
import {
    AddItemStatementRequestAllOfStatementFromJSON,
    AddItemStatementRequestAllOfStatementFromJSONTyped,
    AddItemStatementRequestAllOfStatementToJSON,
} from './AddItemStatementRequestAllOfStatement';
...
export interface AddItemStatementRequest {
    /**
     * 
     * @type {AddItemStatementRequestAllOfStatement}
     * @memberof AddItemStatementRequest
     */
    statement: AddItemStatementRequestAllOfStatement;
    /**
     * 
     * @type {Array<string>}
     * @memberof AddItemStatementRequest
...
export function AddItemStatementRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddItemStatementRequest {
    ...
    return {
        ...
        'statement': AddItemStatementRequestAllOfStatementFromJSON(json['statement']),
...
export function AddItemStatementRequestToJSON(value?: AddItemStatementRequest | null): any {
    ...
    return {
        ...
        'statement': AddItemStatementRequestAllOfStatementToJSON(value['statement']),
        'tags': value['tags'],
        'bot': value['bot'],
