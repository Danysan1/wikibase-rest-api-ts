...
export interface GetItemDescriptionWithFallbackRequest {
    itemId: string;
    languageCode: string;
    ifNoneMatch?: Array<string>;
    ifModifiedSince?: string;
...
export interface GetPropertyDescriptionWithFallbackRequest {
    propertyId: string;
    languageCode: string;
    ifNoneMatch?: Array<string>;
    ifModifiedSince?: string;
...
export interface SetPropertyDescriptionRequest {
    propertyId: string;
    languageCode: string;
    ifNoneMatch?: Array<string>;
    ifModifiedSince?: string;
...
export class DescriptionsApi extends runtime.BaseAPI {
    ...
    async deleteItemDescriptionRaw(requestParameters: DeleteItemDescriptionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/v1/entities/items/{item_id}/descriptions/{language_code}`.replace(`{${"item_id"}}`, encodeURIComponent(String(requestParameters['itemId']))).replace(`{${"language_code"}}`, encodeURIComponent(String(requestParameters['languageCode']))),
            method: 'DELETE',
    ...
    async deletePropertyDescriptionRaw(requestParameters: DeletePropertyDescriptionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/v1/entities/properties/{property_id}/descriptions/{language_code}`.replace(`{${"property_id"}}`, encodeURIComponent(String(requestParameters['propertyId']))).replace(`{${"language_code"}}`, encodeURIComponent(String(requestParameters['languageCode']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: DeleteSitelinkRequestToJSON(requestParameters['deleteSitelinkRequest']),
     ...
     */
    async getItemDescriptionWithFallbackRaw(requestParameters: GetItemDescriptionWithFallbackRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['itemId'] == null) {
            throw new runtime.RequiredError(
                'itemId',
                'Required parameter "itemId" was null or undefined when calling getItemDescriptionWithFallback().'
            );
        }
        ...
        if (requestParameters['languageCode'] == null) {
            throw new runtime.RequiredError(
                'languageCode',
                'Required parameter "languageCode" was null or undefined when calling getItemDescriptionWithFallback().'
            );
        }
        ...
        const response = await this.request({
            path: `/v1/entities/items/{item_id}/descriptions_with_language_fallback/{language_code}`.replace(`{${"item_id"}}`, encodeURIComponent(String(requestParameters['itemId']))).replace(`{${"language_code"}}`, encodeURIComponent(String(requestParameters['languageCode']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Retrieve an Item\'s description in a specific language, with language fallback
     */
    async getItemDescriptionWithFallback(requestParameters: GetItemDescriptionWithFallbackRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.getItemDescriptionWithFallbackRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async getItemDescriptionsRaw(requestParameters: GetItemDescriptionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: string; }>> {
        ...
        const response = await this.request({
            path: `/v1/entities/items/{item_id}/descriptions`.replace(`{${"item_id"}}`, encodeURIComponent(String(requestParameters['itemId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     */
    async getPropertyDescriptionWithFallbackRaw(requestParameters: GetPropertyDescriptionWithFallbackRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['propertyId'] == null) {
            throw new runtime.RequiredError(
                'propertyId',
                'Required parameter "propertyId" was null or undefined when calling getPropertyDescriptionWithFallback().'
            );
        }
        ...
        if (requestParameters['languageCode'] == null) {
            throw new runtime.RequiredError(
                'languageCode',
                'Required parameter "languageCode" was null or undefined when calling getPropertyDescriptionWithFallback().'
            );
        }
        ...
        const response = await this.request({
            path: `/v1/entities/properties/{property_id}/descriptions_with_language_fallback/{language_code}`.replace(`{${"property_id"}}`, encodeURIComponent(String(requestParameters['propertyId']))).replace(`{${"language_code"}}`, encodeURIComponent(String(requestParameters['languageCode']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Retrieve a Property\'s description in a specific language, with language fallback
     */
    async getPropertyDescriptionWithFallback(requestParameters: GetPropertyDescriptionWithFallbackRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.getPropertyDescriptionWithFallbackRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async getPropertyDescriptionsRaw(requestParameters: GetPropertyDescriptionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: string; }>> {
        ...
        const response = await this.request({
            path: `/v1/entities/properties/{property_id}/descriptions`.replace(`{${"property_id"}}`, encodeURIComponent(String(requestParameters['propertyId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async patchItemDescriptionsRaw(requestParameters: PatchItemDescriptionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: string; }>> {
        ...
        if (requestParameters['patchItemRequest'] == null) {
            throw new runtime.RequiredError(
                'patchItemRequest',
                'Required parameter "patchItemRequest" was null or undefined when calling patchItemDescriptions().'
            );
        }
    ...
    async patchPropertyDescriptionsRaw(requestParameters: PatchPropertyDescriptionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: string; }>> {
        ...
        if (requestParameters['patchItemRequest'] == null) {
            throw new runtime.RequiredError(
                'patchItemRequest',
                'Required parameter "patchItemRequest" was null or undefined when calling patchPropertyDescriptions().'
            );
        }
     ...
     */
    async setPropertyDescriptionRaw(requestParameters: SetPropertyDescriptionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['propertyId'] == null) {
            throw new runtime.RequiredError(
                'propertyId',
                'Required parameter "propertyId" was null or undefined when calling setPropertyDescription().'
            );
        }
        ...
        if (requestParameters['languageCode'] == null) {
            throw new runtime.RequiredError(
                'languageCode',
                'Required parameter "languageCode" was null or undefined when calling setPropertyDescription().'
            );
        }
     ...
     * Add / Replace a Property\'s description in a specific language
     */
    async setPropertyDescription(requestParameters: SetPropertyDescriptionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.setPropertyDescriptionRaw(requestParameters, initOverrides);
        return await response.value();
    }
