...
export class ItemsApi extends runtime.BaseAPI {
     ...
     */
    async addItemRaw(requestParameters: AddItemOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Item>> {
     ...
     * Create a Wikibase Item
     */
    async addItem(requestParameters: AddItemOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Item> {
    ...
    async getItemRaw(requestParameters: GetItemRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Item>> {
        ...
        const response = await this.request({
            path: `/v1/entities/items/{item_id}`.replace(`{${"item_id"}}`, encodeURIComponent(String(requestParameters['itemId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     */
    async patchItemRaw(requestParameters: PatchItemOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Item>> {
        if (requestParameters['itemId'] == null) {
            throw new runtime.RequiredError(
                'itemId',
        ...
        if (requestParameters['patchItemRequest'] == null) {
            throw new runtime.RequiredError(
                'patchItemRequest',
                'Required parameter "patchItemRequest" was null or undefined when calling patchItem().'
            );
        }
     ...
     * Change a single Wikibase Item by ID
     */
    async patchItem(requestParameters: PatchItemOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Item> {
