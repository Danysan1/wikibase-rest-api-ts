...
export class StatementsApi extends runtime.BaseAPI {
    ...
    async addItemStatementRaw(requestParameters: AddItemStatementOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AddItemStatement201Response>> {
        ...
        const response = await this.request({
            path: `/v1/entities/items/{item_id}/statements`.replace(`{${"item_id"}}`, encodeURIComponent(String(requestParameters['itemId']))),
            method: 'POST',
    ...
    async addPropertyStatementRaw(requestParameters: AddPropertyStatementRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AddItemStatement201Response>> {
        ...
        const response = await this.request({
            path: `/v1/entities/properties/{property_id}/statements`.replace(`{${"property_id"}}`, encodeURIComponent(String(requestParameters['propertyId']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: AddItemStatementRequestToJSON(requestParameters['addItemStatementRequest']),
    ...
    async deleteItemStatementRaw(requestParameters: DeleteItemStatementRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/v1/entities/items/{item_id}/statements/{statement_id}`.replace(`{${"item_id"}}`, encodeURIComponent(String(requestParameters['itemId']))).replace(`{${"statement_id"}}`, encodeURIComponent(String(requestParameters['statementId']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
    ...
    async deletePropertyStatementRaw(requestParameters: DeletePropertyStatementRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/v1/entities/properties/{property_id}/statements/{statement_id}`.replace(`{${"property_id"}}`, encodeURIComponent(String(requestParameters['propertyId']))).replace(`{${"statement_id"}}`, encodeURIComponent(String(requestParameters['statementId']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: DeleteSitelinkRequestToJSON(requestParameters['deleteSitelinkRequest']),
    ...
    async deleteStatementRaw(requestParameters: DeleteStatementRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/v1/statements/{statement_id}`.replace(`{${"statement_id"}}`, encodeURIComponent(String(requestParameters['statementId']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: DeleteSitelinkRequestToJSON(requestParameters['deleteSitelinkRequest']),
    ...
    async patchItemStatementRaw(requestParameters: PatchItemStatementRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AddItemStatement201Response>> {
        ...
        if (requestParameters['patchItemRequest'] == null) {
            throw new runtime.RequiredError(
                'patchItemRequest',
                'Required parameter "patchItemRequest" was null or undefined when calling patchItemStatement().'
            );
        }
    ...
    async patchPropertyStatementRaw(requestParameters: PatchPropertyStatementRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AddItemStatement201Response>> {
        ...
        if (requestParameters['patchItemRequest'] == null) {
            throw new runtime.RequiredError(
                'patchItemRequest',
                'Required parameter "patchItemRequest" was null or undefined when calling patchPropertyStatement().'
            );
        }
    ...
    async patchStatementRaw(requestParameters: PatchStatementRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AddItemStatement201Response>> {
        ...
        if (requestParameters['patchItemRequest'] == null) {
            throw new runtime.RequiredError(
                'patchItemRequest',
                'Required parameter "patchItemRequest" was null or undefined when calling patchStatement().'
            );
        }
